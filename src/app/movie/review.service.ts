...
export class ReviewService {
    ...
    private reviewsUrl: string = '/api/specific-movie-reviews/';  // URL to web API
    private userReviewsUrl: string = '/api/reviews/specific-user-reviews/'; // URL to web API
    ...
    summarizeRatings(reviews: any): Promise<any>{
    ...
    sendReview(userId: any, movieId: any, title: string, review: string, rating: number){
